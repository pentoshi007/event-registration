...
import { LogOut, Menu, X, ChevronDown, Calendar, Edit, Lock } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 shadow-lg transition-all duration-300 ${isAuthenticated ? 'animate-slide-in-top' : ''
                        ...
                        <div className="bg-white">
                          ...
                          <div className="py-2">
                            <Link
                              ...
                              className={`flex items-center px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base transition-all duration-200 group ${isActive('/')
                            ...
                            <button
                              ...
                              disabled={isLoading}
                              className={`w-full flex items-center px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base transition-all duration-200 group ${isLoading
                                ? 'text-gray-500 cursor-not-allowed'
                                : 'text-gray-800 hover:bg-red-50 hover:text-red-700'
                                }`}
                            >
                              <div className={`flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-lg mr-3 sm:mr-4 transition-all duration-200 ${isLoading
                      ...
                      <div className="absolute right-0 mt-3 w-72 max-w-[calc(100vw-2rem)] sm:max-w-xs bg-white border border-gray-200 rounded-2xl shadow-2xl z-50 overflow-hidden animate-fade-in transform origin-top-right transition-all duration-200 ease-out scale-100">
                        <div className="bg-white">
                          ...
                          <div className="px-4 py-3 border-b border-gray-200">
                            <div className="flex items-center space-x-3">
                              <Avatar user={user!} size="md" className="shadow-lg" />
                              <div className="flex-1 min-w-0">
                          ...
                          <div className="py-1">
                            <Link
                              to="/my-events"
                              onClick={() => setIsProfileDropdownOpen(false)}
                              className={`flex items-center px-4 py-2.5 text-sm transition-all duration-200 group ${isActive('/my-events')
                                ? 'text-blue-700 bg-blue-50 border-l-4 border-blue-500'
                                : 'text-gray-800 hover:bg-gray-50 hover:text-blue-700'
                                }`}
                            >
                            ...
                            <Link
                              to="/profile"
                              onClick={() => setIsProfileDropdownOpen(false)}
                              className={`flex items-center px-4 py-2.5 text-sm transition-all duration-200 group ${isActive('/profile')
                                ? 'text-blue-700 bg-blue-50 border-l-4 border-blue-500'
                                : 'text-gray-800 hover:bg-gray-50 hover:text-blue-700'
                                }`}
                            >
                            ...
                            <Link
                              to="/change-password"
                              onClick={() => setIsProfileDropdownOpen(false)}
                              className={`flex items-center px-4 py-2.5 text-sm transition-all duration-200 group ${isActive('/change-password')
                                ? 'text-blue-700 bg-blue-50 border-l-4 border-blue-500'
                                : 'text-gray-800 hover:bg-gray-50 hover:text-blue-700'
                                }`}
                            >
                            ...
                            <button
                              onClick={handleLogout}
                              disabled={isLoading}
                              className={`w-full flex items-center px-4 py-2.5 text-sm transition-all duration-200 group ${isLoading
                                ? 'text-gray-500 cursor-not-allowed'
                                : 'text-gray-800 hover:bg-red-50 hover:text-red-700'
                                }`}
                            >
                              <div className={`flex items-center justify-center w-7 h-7 rounded-lg mr-3 transition-all duration-200 ${isLoading
                                ? 'bg-gray-500/10 border border-gray-300/20'
                                : 'bg-red-500/10 border border-red-300/20 group-hover:bg-red-500/20 group-hover:border-red-400/30'
                                }`}>
                                {isLoading ? (
        ...
        <div className="md:hidden border-t border-gray-200 bg-white/90 backdrop-blur-md">
          <div className="px-2 pt-2 pb-3 space-y-2 sm:px-3">
            ...
            {isAuthenticated && isAdmin && (
              <Link
                to="/admin"
                className={`block font-bold text-white text-base bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 px-4 py-2.5 rounded-lg border-2 border-blue-300 shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-200 transform hover:scale-105 hover:shadow-2xl duration-200 mx-3 text-center transition-colors ${isActive('/admin')
                  ? 'from-blue-600 to-blue-800 scale-105'
                  : ''
                  }`}
                onClick={() => setIsMenuOpen(false)}
            ...
            {isAuthenticated ? (
              <div className="pt-4 pb-2 border-t border-gray-200">
                ...
                {isAdmin && (
                  <Link
                    to="/"
                    className={`block text-base font-medium transition-colors mx-3 rounded-lg ${isActive('/')
                ...
                {!isAdmin && (
                  <>
                    <Link
                      to="/my-events"
                      className={`block text-base font-medium transition-colors mx-3 rounded-lg ${isActive('/my-events')
                        ? 'text-blue-600 font-semibold bg-blue-50 px-3 py-3 border border-blue-200'
                        : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-3'
                        }`}
                      onClick={() => setIsMenuOpen(false)}
                    ...
                    <Link
                      to="/profile"
                      className={`block text-base font-medium transition-colors mx-3 rounded-lg ${isActive('/profile')
                        ? 'text-blue-600 font-semibold bg-blue-50 px-3 py-3 border border-blue-200'
                        : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-3'
                        }`}
                      onClick={() => setIsMenuOpen(false)}
                    ...
                    <Link
                      to="/change-password"
                      className={`block text-base font-medium transition-colors mx-3 rounded-lg ${isActive('/change-password')
                        ? 'text-blue-600 font-semibold bg-blue-50 px-3 py-3 border border-blue-200'
                        : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50 px-3 py-3'
                        }`}
                      onClick={() => setIsMenuOpen(false)}
                ...
                <button
                  onClick={handleLogout}
                  disabled={isLoading}
                  className={`w-full text-left block px-3 py-2 rounded-md text-base font-medium transition-all duration-200 ${isLoading
                    ? 'text-gray-500 cursor-not-allowed'
